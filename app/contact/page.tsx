...
const SectionHeading = ({ title }: { title: string }) => (
  <h3
    className="relative inline-block text-2xl font-serif font-bold mb-6
      ...
      <section className="bg-[#F9F6F0] py-24">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <div className="rounded-2xl border border-black/10 bg-white shadow-md overflow-hidden">
              <div className="p-6 space-y-6">
                ...
                {/* Embedded Map */}
                <div className="w-full h-52 rounded-xl overflow-hidden border border-black/10 shadow-sm">
                  <iframe
                    title="URFM Location"
              ...
              <table className="w-full text-sm table-auto">
                ...
                <tbody className="divide-y">
                  {[
                    ...
                    >
                      <td className="px-5 py-3 font-medium">{item.service}</td>
          ...
          <div>
            ...
            <div className="rounded-2xl bg-white border border-black/10 shadow-md p-8 flex flex-col justify-between space-y-6">
